...
public final class PeptidePairProcessor extends JamApp {
     ...
     * output file.
     */
    public static final String OUTPUT_FILE_PROPERTY = "jean.neo.PeptidePairProcessor.reportFile";
     ...
     * an array: {@code jean.neo.peptideLengths = 9, 10}.
     */
    public static final String PEPTIDE_LENGTHS_PROPERTY = "jean.neo.PeptidePairProcessor.peptideLengths";
    ...
    private void run() {
        writeRuntimeEnv("JAM_", "JEAN_");
        writeRuntimeProperties("jam.", "jean.");
