...
public final class MAFProperties {
     ...
     */
    public static final String MAF_FILE_PROPERTY = "jean.maf.mafFileInput";

    /**
     * Name of the output FASTA file to write.
     */
    public static final String FASTA_FILE_PROPERTY = "jean.maf.fastaFileOutput";

    /**
     * Name of the MAF file column containing the tumor barcode.
     */
    public static final String TUMOR_BARCODE_COLUMN_PROPERTY = "jean.maf.tumorBarcodeColumn";

    /**
     * Name of the MAF file column containing the HUGO symbol.
     */
    public static final String HUGO_SYMBOL_COLUMN_PROPERTY = "jean.maf.hugoSymbolColumn";

    /**
     * Name of the MAF file column containing the Ensembl transcript key.
     */
    public static final String TRANSCRIPT_COLUMN_PROPERTY = "jean.maf.transcriptColumn";

    /**
     * Name of the MAF file column containing the variant classification.
     */
    public static final String CLASSIFICATION_COLUMN_PROPERTY = "jean.maf.classificationColumn";

    /**
     * Name of the MAF file column containing the variant type.
     */
    public static final String VARIANT_TYPE_COLUMN_PROPERTY = "jean.maf.variantTypeColumn";

    /**
     * Name of the MAF file column containing the protein change.
     */
    public static final String PROTEIN_CHANGE_COLUMN_PROPERTY = "jean.maf.proteinChangeColumn";

    /**
     * Name of the MAF file column containing the cancer cell fraction.
     */
    public static final String CELL_FRACTION_COLUMN_PROPERTY = "jean.maf.cellFractionColumn";

    /**
     * Minimum cancer cell fraction required to process a mutation.
     */
    public static final String CCF_THRESHOLD_PROPERTY = "jean.maf.ccfThreshold";
